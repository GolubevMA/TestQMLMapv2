...
function initializeGL(canvas) {
    canvas3d = canvas
    try {
        // полкчаем oopengl context для данног API
...
function initBuffers() {
    //создаем буффр вершин куба
    //посколльку мы используем текстуры,
    //необходиммо писаьт вершны каждой грани
    ...
    // Сохдаим буфер для массива с индескоми
    //We define six sides, each composed of two
